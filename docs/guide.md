...
| `added_at` | строка | Date the track was added to the playlist in string format. An example of use in a template [loved and forgotten] (/template?id=Любимо-и-забыто).
